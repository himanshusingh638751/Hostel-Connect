...
const replacements = [
  ...
  { regex: /bg-indigo-950/g, replacement: 'bg-indigo-50' },
  { regex: /border-indigo-800/g, replacement: 'border-indigo-200' },
  { regex: /bg-slate-950\/90/g, replacement: 'bg-white/90' },
  { regex: /text-amber-400/g, replacement: 'text-amber-500' },
];
